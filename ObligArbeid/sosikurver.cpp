...
SosiKurver::SosiKurver() : DisplayObject()
{
    lesfil("C:/Users/mads/Desktop/Visim/Kartdata_403_Hamar_UTM33_N50_SOSI/SosiTestKurver.txt");

}

SosiKurver::~SosiKurver()
{
    delete [] m_vertices;
}

void SosiKurver::lesfil(std::string filnavn)
{
...
void SosiKurver::initVertexBufferObjects()
{
...
void SosiKurver::draw(GLint positionAttribute, GLint normalAttribute, GLint textureAttribute)
{
    ...
    glDrawArrays(GL_LINE_STRIP, 0, m_antallVertices);
}
